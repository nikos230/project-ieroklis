...
To fine-tune the MedST-28 model for the Fire Risk task, the ViT decoder was replaced with an LSTM decoder. This modification enables the model to learn temporal features. The features learned by the pre-trained encoder are high-quality and informative, allowing the decoder to leverage them effectively.

### MedST-28 fine-tune for Fire Spread
To fine-tune the MedST-28 model for the Fire Spread task, the ViT decoder was replaced with an Convolutional decoder. This modification enables the model to learn spatial features. The features learned by the pre-trained encoder are high-quality and informative, allowing the decoder to leverage them effectively.

| MedST-28 | MedST-28 fine-tune for Fire Risk | MedST-28 fine-tune for Fire Spread |
|----------|----------------------------------|-----------------------------------|
| | | |
| <img src="https://github.com/nikos230/project-ieroklis/blob/main/misc/pre-training-setup.png" width="300"> | <img src="https://github.com/nikos230/project-ieroklis/blob/main/misc/fine_tune_fire_risk_setup.png" width="300"> | <img src="https://github.com/nikos230/project-ieroklis/blob/main/misc/fine_tune_fire_spread_setup.png" width="300"> |
